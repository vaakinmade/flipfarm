...
def create_commodity_factory(name: str, interest_yield: float, location: str, category: str, duration: int,
                             amount: Money, id: int = None, fund_status: FundStatus = FundStatus.PRE_FUNDING,
...
def update_commodity_factory(id_: str, id: int = None, name: str = None, interest_yield: float = None,
                             location: str = None, category: str = None, duration: int = None, amount: Money = None,
                             fund_status: FundStatus = None, location_thumbnail: str = None,
                             amount_raised: Money = None, created_at: datetime = None
...
def update_investment_factory(id_: str, commodity_id: int = None, investor_id: int = None,amount: Money = None,
                              status: str = None, maturity_date: datetime = None, created_at: datetime = None,
                              updated_at: datetime = None) -> UpdateInvestmentInputDto:
